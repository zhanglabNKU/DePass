...
EOF
    ...
    Pro_path_train="/home/jyx/DePass-main/outputs/DePassData/${pair_dir}/${dataset1}/adata_meta.h5ad"

    RNA_path_test="/home/jyx/DePass-main/outputs/DePassData/${pair_dir}/${dataset2}/adata_RNA.h5ad"
    Pro_path_test="/home/jyx/DePass-main/outputs/DePassData/${pair_dir}/${dataset2}/adata_meta.h5ad"


    for r in $(seq "$start" "$repeat_len"); do
        echo "Processing dataset pair: train: $dataset1, test: $dataset2, repeat $r"
        python /home/jyx/depassfortranslation/methods/sc/rna_pro/scMOG/scMOG_code/bin/train_inter.py \
            --repeat="$r" \
